...
namespace Models.Test
{
    public class UserRepositoryTests : IDisposable
    {
        ...
        public async Task create_user_taken_username()
        {
            ...
            Assert.Equal(CreateReturnType.USERNAME_TAKEN, result);
        }
        ...
        public async Task create_user_invalid_email()
        {
            ...
            Assert.Equal(CreateReturnType.INVALID_EMAIL, result);
        }
        ...
        public async Task create_user_taken_email()
        {
            ...
            Assert.Equal(CreateReturnType.EMAIL_TAKEN, result);
        }
        ...
        public async Task create_user_password_mismatch()
        {
            ...
            Assert.Equal(CreateReturnType.PASSWORD_MISMATCH, result);
        }

        [Fact]
        public async Task create_user_no_password()
        {
            var result = await repo.CreateAsync(new UserCreateDTO { Username = "user5", Email = "user5@mail.io", Password1 = "", Password2 = ""});

            Assert.Equal(CreateReturnType.MISSING_PASSWORD, result);
        }
